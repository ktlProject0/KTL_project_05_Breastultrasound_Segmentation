# KTL_project_05_Breastultrasound_Segmentation
...
- Clone this repo:
```bash
git clone https://github.com/ktlProject0/KTL_project_05_Breastultrasound_Segmentation.git
cd KTL_project_05_Breastultrasound_Segmentation
```
